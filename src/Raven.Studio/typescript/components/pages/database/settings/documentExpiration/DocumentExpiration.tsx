                                        ...
                                        <div className="vstack gap-2">
                                            ...
                                            <div>
                                                ...
                                                <FormInput
                                                    ...
                                                    type="number"
                                                    disabled={
                                                        formState.isSubmitting || !formValues.isExpirationFrequencyEnabled
                                                    }
                    ...
                    <Col sm={12} lg={4}>
                        <AboutViewAnchored>
                            ...
                            >
                                ...
                                <ul>
                                    <li>The server scans the database at the specified <strong>frequency</strong>, searching for documents that should be deleted.</li>
                                    <li>
                                        Any document that has an <code>@expires</code> metadata property whose time has passed at the time of the scan will be removed.
                                    </li>
                                </ul>
